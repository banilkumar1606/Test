...
public class Person {
    ...
    public static void main(String[] args) {
        Person p1 = new Person("John", 25); // "p1" is object reference in stack pointing to the object in the heap
    ...
    public void addOneAndPrint(String param) {
        ...
        System.out.println(param + "! " + this.toString()); // calls toString() method
    }
